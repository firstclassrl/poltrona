      ...
      <Card className="p-8 max-w-2xl w-full space-y-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <textarea
              className="w-full border border-input bg-surface text-on-surface rounded-lg p-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary/60"
              rows={3}
          ...
          <div className="surface-card-alt border border-[color-mix(in_srgb,var(--theme-border)_30%,transparent)] rounded-lg p-4">
            <ThemeSelector
