...
export const THEME_PALETTES: ThemePalette[] = [
  ...
  },
  {
    ...
    previewGradient: 'linear-gradient(135deg, #ff7664 0%, #f7de8b 100%)',
    colors: {
      background: '#ffffff',
      surface: '#ffffff',
      surfaceAlt: '#f5f7fb',
  ...
  },
  {
    ...
    previewGradient: 'linear-gradient(135deg, #f2ddc8 0%, #f4c978 100%)',
    colors: {
      background: '#f7f2eb',
      surface: '#ffffff',
      surfaceAlt: '#f1e5d9',
  ...
  },
  {
    ...
    previewGradient: 'linear-gradient(135deg, #dcd6ff 0%, #f7d9ff 100%)',
    colors: {
      background: '#ffffff',
      surface: '#ffffff',
      surfaceAlt: '#f7f5ff',
